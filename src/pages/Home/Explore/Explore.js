        ...
        <div>
            <div className='my-5 card-text '>
                <div className='grid gap-3 grid-cols-1 lg:grid-cols-3  '>
                    <div className='bg-gradient-to-tl from-slate-400 to-violet-400 p-5 rounded-lg inline-flex items-center '>
                    ...
                    <div className='text-5xl p-5 bg-gradient-to-bl from-amber-200 to-red-300 rounded-full inline-flex items-center'>
                    ...
                    <div className='text-5xl p-5 bg-gradient-to-b from-violet-400 to-red-300 rounded-lg inline-flex items-center '>
