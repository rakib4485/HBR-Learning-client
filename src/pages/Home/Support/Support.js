    ...
    return (
        <div className='my-20 card-text'>
            <div className='grid gap-3 grid-cols-1 lg:grid-cols-4'>
                <div className='bg-gradient-to-tl from-slate-400 to-violet-400 p-5 rounded-lg'>
                ...
                <div className='text-5xl p-5 bg-gradient-to-br from-indigo-400 to-slate-400 rounded-lg'>
                ...
                <div className='text-5xl p-5 bg-gradient-to-b from-violet-400 to-red-300 rounded-lg'>
                ...
                <div className='text-5xl p-5 bg-gradient-to-bl from-amber-200 to-red-300 rounded-lg'>
